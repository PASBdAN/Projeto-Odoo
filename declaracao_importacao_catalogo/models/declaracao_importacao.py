...
class DeclaracaoImportacao(models.Model):
    _name = "declaracao.importacao"             ##objeto geral de toda a tela
    _description = "Declaração da Importação (DI)"

    name = fields.Char(string="Número da DI", )
    ...
    seller_id = fields.Many2one(
        string="Fornecedor",
        comodel_name="res.partner",       ##esse é o nome do objeto Fornecedor
